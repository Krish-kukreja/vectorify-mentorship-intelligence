...
- [x] **4.** `.env.example` with all required keys (PORT, NODE_ENV, JWT_SECRET, DATABASE_URL, GEMINI_API_KEY, RESEND_API_KEY, REMINDER_CRON_SCHEDULE)
...
- [x] **24.** `analysis.service.ts` — Gemini call with 1 retry, JSON parse, key validation, citation cleaning, auto-create ActionItems
...
- [x] **38.** DECISIONS.md — PostgreSQL, Prisma, Gemini, Resend, Railway, JWT rationale

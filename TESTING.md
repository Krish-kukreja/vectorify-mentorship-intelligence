...
**34 tests** across 4 modules. All tests use mocked Prisma and external APIs (Gemini, Resend) for fast, deterministic execution.
...
| Analysis | `src/__tests__/analysis.test.ts` | 5 | AI analysis, conflicts, Gemini failures, citations |
...
| 4 | Gemini fails twice | 502 LLM_ERROR | Both attempts throw | 
...
- Gemini SDK is also mocked to prevent real API calls and cost.
